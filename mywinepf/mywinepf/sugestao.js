...
export default function App() {
  ...
  <View style={styles.wineItem}>
    ...
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('Detalhe2')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho3.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('Detalhe3')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho4.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('Detalhe4')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
</View>

{/* Novas imagens com botão "Detalhe" */}
<View style={styles.additionalImagesContainer}>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho4.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('DetalheNova1')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho3.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('DetalheNova2')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho2.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('DetalheNova3')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
  <View style={styles.wineItem}>
    <Image source={require('./assets/vinho1.png')} style={styles.wineImage} />
    <TouchableOpacity style={styles.detalheButton} onPress={() => navigateTo('DetalheNova4')}>
      <Text style={styles.buttonText}>Detalhe</Text>
    </TouchableOpacity>
  </View>
</View>
